...
baseUrl = 'http://localhost:1741/api/Employee/';
employees:IEmployee[];
employee:IEmployee;
...
(this.baseUrl+'/PostEmployee', employee, httpOptions).pipe(catchError(this.handleError));}

updateEmployee(employee: IEmployee): Observable<void> {
const httpOptions ={
headers: new HttpHeaders({
'accept':  'application/json'})};
return this.httpClient.put<void>(this.baseUrl+'/PutEmployee?id='+employee.Id, employee, httpOptions).pipe(catchError(this.handleError));}
