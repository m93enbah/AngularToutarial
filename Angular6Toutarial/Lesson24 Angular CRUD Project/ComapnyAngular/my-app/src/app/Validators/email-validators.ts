...
if (email === '' || domain.toLowerCase() === domainName || domain.toLowerCase() === domainName2) {return null;} else {return { 'emailDomain': true };}}}
...
return null;} else {return { 'CompareEmails': true };}}
